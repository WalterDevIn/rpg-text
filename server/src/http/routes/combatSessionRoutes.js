...
function assertEncounterShape(input) {
  ...
  } else if (!Array.isArray(input.characterIds) || !Array.isArray(input.creatureIds) || !input.assignments || Array.isArray(input.assignments)) throw Object.assign(new Error("Encounter requests require characterIds, creatureIds, assignments, and scenarioId."), { status: 400, code: "INVALID_REQUEST", details: [] });
